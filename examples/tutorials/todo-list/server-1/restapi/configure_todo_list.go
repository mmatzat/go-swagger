...
import (
	...
	"github.com/mmatzat/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/mmatzat/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
