...
import (
	...
	"github.com/mmatzat/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/mmatzat/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
