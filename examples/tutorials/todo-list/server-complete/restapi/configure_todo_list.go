...
import (
	...
	"github.com/mmatzat/go-swagger/examples/tutorials/todo-list/server-complete/models"
	"github.com/mmatzat/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/mmatzat/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)
