...
import (
	...
	"github.com/mmatzat/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/mmatzat/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
